...
; Assumes a layout of a standard "Mac keyboard" where the modifier keys are:
;       Ctrl Alt/Option Cmd Space Cmd Alt/Option Ctrl
; Also works well if you have a mac centric QMK profile that you want to use on a windows PC
...
; another missing control fake out
^Up::SendInput {LWin down}{Tab}{LWin up}
